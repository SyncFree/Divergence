...
* configured using {@link DCDataStoreScheduler}, which places appropriate instances of
...
* valid times as defined by {@link DCDataStoreScheduler#sch}, then the next event is not scheduled.
