...
* true
* </li>
* * <li>{@link DCDataStoreSimulator}:
* if {@link DCDataStoreSimulatorr#isConfigurationDCDriven} returns
* true
* </li>
* </ul>
...
/** {@link DCDataStoreSimulator} */
public static final int DCSIM = 2;
...
protected static final String[] simName = {
	...
	"peersim.core.dcdatastore.DCDataStoreSimulator"
};
...
public static int getSimID() {
	...
	if (simID == UNKNOWN) {
		...
		else if( DCDataStoreSimulator.isConfigurationDCDriven() ) {
			simID = DCSIM;
		}
	}
	return simID;
	...
	try {
		...
		for(int k=0; k<exps; ++k)
		{
			...
			case EDSIM:
				...
				break;
			case DCSIM:
				DCDataStoreSimulator.nextExperiment();
				break;
			}
		}
